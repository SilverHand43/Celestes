...
1. Crie um repositório e envie este `index.html` (e este `README.md`) para a branch principal.
2. Em **Settings → Pages**, selecione a branch e a pasta raiz.
3. O site ficará disponível em `https://SEU_USUARIO.github.io/SEU_REPOSITORIO/`.
